...
# Format: model_name -> {input, output, cache_create, cache_hit}
PRICING_TABLE: dict[str, dict[str, float]] = {
    # Claude models
    "claude-opus-4-6":              {"input": 25.0, "output": 125.0},
    "claude-opus-4-6-thinking":     {"input": 25.0, "output": 125.0},
    ...
    # OpenAI models
    "o3":                           {"input": 15.0, "output": 75.0},
    "o3-mini":                      {"input": 7.5,  "output": 37.5},
    "o4-mini":                      {"input": 7.5,  "output": 37.5},
    "gpt-4o":                       {"input": 12.5, "output": 50.0},
    "gpt-4o-mini":                  {"input": 0.75, "output": 3.0},
    "gpt-4.1":                      {"input": 12.5, "output": 50.0},
    "gpt-4.1-mini":                 {"input": 2.5,  "output": 12.5},
    "gpt-4.1-nano":                 {"input": 0.5,  "output": 2.5},
    "gpt-5":                        {"input": 6.25, "output": 50.0},
    # Gemini models
    "gemini-2.5-pro":               {"input": 7.5,  "output": 37.5},
    "gemini-2.5-flash":             {"input": 0.5,  "output": 2.5},
    "gemini-2.0-flash":             {"input": 0.5,  "output": 2.5},
}
